    ...
    return (
        <>
            ...
            <div className="folder__content" style={{display: `${addTask ? 'block' : 'none'}`}}>
                <form className="folder__form" onSubmit={(e) => addTaskInFolder(e, item.id)} action="">
                    <input className="folder__form-input" required value={task} type="text" placeholder="Текс задачи"
                           onChange={(e) => setTask(e.target.value)}/>
                           <br/>
                    <button className="folder__form-add" type="submit">Добавить</button>
